...
centerComponent={{ text: "Details of this cause",style: {color: "#ffffff",fontSize: RFValue(25),fontWeight: "bold",},}}backgroundColor="#32867d"
...
<View style={{ flex: 2 ,justifyContent:'center',alignItems:'center',borderWidth:2,borderColor:'green',padding:RFValue(10),height: 2000,marginTop: -60}}>
